		...
		<div class="img-login">	
			<center><img src="../IMAGES/mercado.jpg" id="img-login"></center>
				<div class="login-usuario">
					<form class="formulario" name="formulario" action="../DemoServlet" method="GET">
	            		<div class="form-titulo">
			            	 <center><h2>Ingrese sus Credenciales:</h2></center>
			            </div><br>
			             <div class="form-group">
			                <label for="cedula"><i class="bi bi-person"></i><strong> Usuario:</strong></label>
			                <input type="text" class="form-control" id="usuario" name="usuario" placeholder="">
			              </div>
			              <div class="form-group">
			                <label for="exampleInputPassword1"><span class="oi oi-lock-locked"></span><strong>Contraseña:</strong></label>
			                <input type="password" class="form-control" id="exampleInputPassword1" placeholder="" name="contrasena">
			              </div><br>
			              <div class="form-group">
			                <button type="submit" class="btn btn-primary" name="accion" id="btn-ingresar" value="Ingresar">Ingresar</button>
			              </div>
			              <div class="form-group">
